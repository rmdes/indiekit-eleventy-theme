 ...
 * Measured on rmendes (.eleventy-mem.log, 950 completed builds): full builds
 * run 154s median, 266s p90, 461s max. A 120s trigger would kill more real
 * builds than stuck ones. The 900s floor is ~2x the worst build ever observed,
 * and still turns a 24-hour outage into a ~15-minute one.
 *
...
export const RESTART_FLOOR_SECONDS = 900;
